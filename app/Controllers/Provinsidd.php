...
class Provinsidd extends BaseController
{
    ...
    public function list()
    {
        ...
        // dd($list);
        return view('provinsi_listdd', $output);
    }

    public function insert()
    {
        return view('provinsi_insertdd');
    }
    ...
    public function update($id)
    {
        ...
        return view('provinsi_updatedd', $output);
    }
